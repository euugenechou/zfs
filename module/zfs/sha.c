...
void sha3_256_update(struct Sha3_256 *self, uint8_t *data, uint64_t n) {
    absorb(self, data, n);
}

void sha3_256_finalize(struct Sha3_256 *self, uint8_t *digest) {
    squeeze(self, digest);
}
...
#ifdef __KERNEL__
EXPORT_SYMBOL(sha3_256_new);
EXPORT_SYMBOL(sha3_256_update);
EXPORT_SYMBOL(sha3_256_finalize);
EXPORT_SYMBOL(sha3_256_digest);
#endif
